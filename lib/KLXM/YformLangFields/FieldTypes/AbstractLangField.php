...
namespace KLXM\YformLangFields\FieldTypes;

use KLXM\YformLangFields\LangHelper;
use rex_yform_value_abstract;

abstract class AbstractLangField extends rex_yform_value_abstract
{
    ...
    protected function getFieldValue()
    {
        ...
        $postValue = $this->params['request'][$this->getName()] ?? null;
    ...
    public function enterObject()
    {
        ...
        $this->params['form_output'][$this->getId()] = $this->parse([
            ...
            'value.' . $this->getFieldType() . '.tpl.php'
        ], [
            'field' => $this,
            'value' => $value,
    ...
    {
        return 'Mehrsprachiges ' . $this->getFieldType() . '-Feld mit JSON-Speicherung';
    }
