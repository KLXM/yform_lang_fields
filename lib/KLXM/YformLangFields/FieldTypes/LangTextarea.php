...
class rex_yform_value_lang_textarea extends rex_yform_value_abstract
{
    ...
    {
        return 'Mehrsprachiges Textarea-Feld mit JSON-Speicherung';
    }
    ...
    public function getDefinitions(): array
    {
        return [
            ...
            'values' => [
                ...
                'rows' => ['type' => 'text', 'label' => 'Anzahl Zeilen'],
                'cols' => ['type' => 'text', 'label' => 'Anzahl Spalten'],
                'editor' => ['type' => 'boolean', 'label' => 'Editor verwenden (CKEditor5)'],
            ],
    ...
    public function getDbFieldProperties()
    {
        return [
            'type' => 'text',
            'length' => 65535,
